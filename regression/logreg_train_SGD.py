...
def logreg_train(data):
    ...
    for i in range(len(houses)):
        ...
        while loss > 0.1:
            ...
            # update weights
            stochastic_gradient_descent(num_data, weights, p, y, count)
